...
const STUDENTS_IMG = "https://images.pexels.com/photos/7683887/pexels-photo-7683887.jpeg?auto=compress&cs=tinysrgb&w=1920";
...
function RoleSelectionScreen() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-blue-900 to-orange-900 flex flex-col items-center justify-center px-6 relative overflow-hidden">
      <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${STUDENTS_IMG})` }} />
      <div className="absolute inset-0 bg-gradient-to-br from-green-900/70 via-blue-900/70 to-orange-900/70" />
      ...
      <div className="absolute top-20 left-1/2 w-60 h-60 bg-blue-700/15 rounded-full pointer-events-none blur-xl" />
